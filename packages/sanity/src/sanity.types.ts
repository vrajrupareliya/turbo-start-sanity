...
// Query: *[_type == "blog" && (seoHideFromLists != true)] | order(orderRank asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBlogs
// Query: *[_type == "blog" && category._ref == $categoryId && (seoHideFromLists != true)] | order(orderRank asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogCategoryBlogsResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Query: *[_type == "blog" && defined(slug.current) && (seoHideFromLists != true)]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBlogsCount
// Query: count(*[_type == "blog" && category._ref == $categoryId && (seoHideFromLists != true)])
export type QueryBlogCategoryBlogsCountResult = number;

// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategories
// Query: *[_type == "category" && defined(slug.current)] | order(title asc){    _id,    title,    "slug": slug.current,    description,    color,    icon,    "postCount": count(*[_type == "blog" && category._ref == ^._id && (seoHideFromLists != true)])  }
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBySlug
// Query: *[_type == "category" && slug.current == $slug][0]{    _id,    title,    "slug": slug.current,    description,    color,    icon  }
export type QueryBlogCategoryBySlugResult = {
  _id: string;
  title: string;
  slug: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogIndexPageBlogsLatest
// Query: *[_type == "blog" && (seoHideFromLists != true)] | order(publishedAt desc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogIndexPageBlogsLatestResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogIndexPageBlogsOldest
// Query: *[_type == "blog" && (seoHideFromLists != true)] | order(publishedAt asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogIndexPageBlogsOldestResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogIndexPageBlogsTitleAsc
// Query: *[_type == "blog" && (seoHideFromLists != true)] | order(title asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogIndexPageBlogsTitleAscResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBlogsLatest
// Query: *[_type == "blog" && category._ref == $categoryId && (seoHideFromLists != true)] | order(publishedAt desc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogCategoryBlogsLatestResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBlogsOldest
// Query: *[_type == "blog" && category._ref == $categoryId && (seoHideFromLists != true)] | order(publishedAt asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogCategoryBlogsOldestResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogCategoryBlogsTitleAsc
// Query: *[_type == "blog" && category._ref == $categoryId && (seoHideFromLists != true)] | order(title asc) [$start...$end]{      _type,  _id,  title,  description,  "slug":slug.current,  orderRank,  pokemonId,  publishedAt,    category->{    _id,    title,    "slug": slug.current,    color,    icon  },    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
export type QueryBlogCategoryBlogsTitleAscResult = Array<{
  _type: "blog";
  _id: string;
  title: string;
  description: string | null;
